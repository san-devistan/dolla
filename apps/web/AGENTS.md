...
SEO-facing workflows, and client integration with generated backend APIs.
...
| Skill              | Invoke when                                                                                       |
| ------------------ | ------------------------------------------------------------------------------------------------- |
| `ai-seo`           | AI search visibility, LLM answer surfaces, topical authority, entity clarity, or answer readiness |
| `programmatic-seo` | Programmatic landing pages, scalable content templates, long-tail page systems, or SEO playbooks  |
| `seo-audit`        | SEO audits, technical SEO checks, international SEO, content quality, or AI-writing detection     |
