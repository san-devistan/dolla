...
} from "@/features/cloudinary/gallery-header"
import { ContactAdminPanel } from "@/features/contact/contact-admin-panel"
import { ContactForm } from "@/features/contact/contact-form"
import { ContactInfo } from "@/features/contact/contact-info"
import { setContactSettingsFn } from "@/features/contact/contact.functions"
...
function ContactPage({
  ...
  useEffect(() => {
    ...
    setDraftRecipients(initialSettings.notificationRecipients)
    setIsSaving(false)
  }, [initialSettings])
