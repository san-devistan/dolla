...
import { getPricingItemsSnapshot, getPricingSaveStatusLabel } from "./items"
import { PricingList } from "./list"
import { usePricingAutosave } from "./use-autosave"
...
function PricingPage({
  ...
  return (
    <PricingPageContent
      key={getPricingItemsSnapshot(initialPricing.items)}
