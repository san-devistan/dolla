  ...
  const mergedFormatters = React.useMemo<Partial<Formatters>>(
    () => ({
      formatMonthDropdown: (date) =>
        date.toLocaleString(locale?.code, SHORT_MONTH_FORMAT_OPTIONS),
      ...formatters,
    }),
...
function CalendarChevron({
  ...
  if (orientation === "left") {
    return <ChevronLeftIcon className={className} {...iconProps} />
  }

  if (orientation === "right") {
    return <ChevronRightIcon className={className} {...iconProps} />
  }

  return <ChevronDownIcon className={className} {...iconProps} />
}
