...
type SkeletonStyle = React.CSSProperties & Record<"--skeleton-width", string>
...
function SidebarMenuButton({
  ...
  const tooltipTriggerRender = React.useMemo(
    () => (tooltip ? <TooltipTrigger render={render} /> : render),
    [render, tooltip]
  )
...
function SidebarMenuSkeleton({
  ...
  const style = React.useMemo<SkeletonStyle>(
